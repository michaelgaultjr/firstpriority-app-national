...
class GreetersMultiSelectDialog extends StatelessWidget {
    ...
    return  Column(
      ...
      children: [
        MultiSelectDialogField(
          ...
          onConfirm: (results) {
            _eventsController.greeterText.value = '';
            results.forEach((element) {
              if(_eventsController.greeterText.value == ''){
                _eventsController.greeterText.value = element.name;
              }else {
                _eventsController.greeterText.value =
                    _eventsController.greeterText.value + ', ' + element.name;
              }});
