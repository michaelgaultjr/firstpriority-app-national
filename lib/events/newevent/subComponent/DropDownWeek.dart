      ...
      children: [
        Container(
          child: Obx(
              ...
              value:  _eventsController.weekSelectedValue.value,
              iconSize: 24,
              selectedItemBuilder: (BuildContext context) {
                return _eventsController.weekList.map<Widget>((String item) {
                  return Text(item);
                }).toList();
              },
              style: TextStyle(
              ...
              onChanged: (String data) {
                _eventsController.weekSelectedValue.value = data;
              },
              items: _eventsController.weekList
