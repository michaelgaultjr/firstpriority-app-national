...
class SetUpMultiSelectDialog extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        MultiSelectDialogField(
          ...
          onConfirm: (results) {
            _eventsController.setupText.value = '';
            results.forEach((element) {
              if (_eventsController.setupText.value == '') {
                _eventsController.setupText.value = element.name;
              } else {
                _eventsController.setupText.value =
                    _eventsController.setupText.value + ', ' + element.name;
              }
