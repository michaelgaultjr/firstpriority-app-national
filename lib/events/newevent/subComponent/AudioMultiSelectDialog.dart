...
class AudioMultiSelectDialog extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        MultiSelectDialogField(
          ...
          onConfirm: (results) {
            _eventsController.audioText.value = '';
            results.forEach((element) {
              if (_eventsController.audioText.value == '') {
                _eventsController.audioText.value = element.name;
              } else {
                _eventsController.audioText.value =
                    _eventsController.audioText.value + ', ' + element.name;
              }
