...
class PrayerMultiSelectDialog extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        MultiSelectDialogField(
          ...
          onConfirm: (results) {
            _eventsController.prayerText.value = '';
            results.forEach((element) {
              if (_eventsController.prayerText.value == '') {
                _eventsController.prayerText.value = element.name;
              } else {
                _eventsController.prayerText.value =
                    _eventsController.prayerText.value + ', ' + element.name;
              }
